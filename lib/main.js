...
function shutdown(params, aReason) {
  ...
  if (aReason == 4/*ADDON_DISABLE*/ || aReason == 6/*ADDON_UNINSTALL*/) {
    ...
    let buttonPressed = ps.confirmEx(null,
      stringBundle.GetStringFromName("resetDialogOnDisable.title"),
      stringBundle.GetStringFromName("resetDialogOnDisable.message"),
      ...
      stringBundle.GetStringFromName("resetDialogOnDisable.reset.label"),
      null,
      stringBundle.GetStringFromName("resetDialogOnDisable.keep.label"),
      null,
      { value: null });
